  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
      <div class="w-full sm:p-4 px-4 mb-6">
        <h1 class="title-font font-medium text-xl mb-2 text-gray-900">BirlaG visa & Immigration</h1>
        <div class="leading-relaxed">BIRLA G is one of the leading global resettlement solution service providers offering full range of services in the area of SKILLED, STUDENT AND BUSINESS IMMIGRATION.</div>
      </div>
      <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
        <h2 class="title-font font-medium text-3xl text-gray-900">501</h2>
        <p class="leading-relaxed">Happy Student</p>
      </div>
      <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
      ...
      <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
        <h2 class="title-font font-medium text-3xl text-gray-900">1200</h2>
    ...
    <div class="lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
      <img class="object-cover object-center w-full h-full" src="./img/b.jpg" alt="stats">
    </div>
  </div>
</section>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-4 text-center">
      <div class="p-4 sm:w-1/4 w-1/2">
        <h2 class="title-font font-medium sm:text-4xl text-3xl text-gray-900">501</h2>
        <p class="leading-relaxed">Happy Student</p>
      </div>
      <div class="p-4 sm:w-1/4 w-1/2">
