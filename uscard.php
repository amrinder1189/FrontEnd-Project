...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <h2 class="sm:text-3xl text-2xl text-gray-900 font-medium title-font mb-2 md:w-1/5"  style='color:#D92E7C; font-size:1.4rem;'>USA Green Card</h2>
...
<br>
<span style='color:black;font-weight:bolder';>US EB-5 </span><br>
...
<br>
      <span style='color:black;font-weight:bolder';>What is a Regional Center?
...
<br>
      <span style='color:black;font-weight:bolder';>Eligibility Criteria</span><br>
    <ul style='list-style-type:circle'>
    <li>Investment: Invest $ 900,000 in a government approved Regional Center
</li>
    <li>Source of funds: Source of funds should be legal
</li>
    <li>Age: Must be at least 21 years old</li>
    <li>Experience: No prior business experience required</li>
    <li>Education: No minimum education requirement</li>
    <li>Language: English language not necessary</li>
    <li>Dependent: Dependent under 21 years of age can be included in the application</li>
