...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <h2 class="sm:text-3xl text-2xl text-gray-900 font-medium title-font mb-2 md:w-1/5"  style='color:#D92E7C; font-size:1.4rem;'>USA Student Visa</h2>
...
In fact, international students comprise approximately 4% of the total undergraduate US University and US College population and 10% for US Graduate School.<br>

<span style='color:black;font-weight:bolder';>Application Procedure</span><br>
    ...
    <div class="-my-8 divide-y-2 divide-gray-100">
      <div class="py-8 flex flex-wrap md:flex-nowrap">
        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
         <span class="font-semibold title-font text-gray-700" style='color:#D92E7C; font-weight:400;font-size:1rem'>Universities & Colleges in US</span>
        </div>
