...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <h2 class="sm:text-3xl text-2xl text-gray-900 font-medium title-font mb-2 md:w-1/5" style='color:#D92E7C; font-size:1.4rem;'>Australia Business Visa</h2>
    ...
    <!-- <h2 class="sm:text-3xl text-2xl text-gray-900 font-medium title-font mb-2 md:w-2/5" style='color:#D92E7C'>Skilled Workers Visa</h2> -->
      <p class="leading-relaxed text-base" style='color:black;opacity:1;font-weight:400;'>A business visa offers a number of advantages including a Work permit visa of up to 4 years and the applicant’s immediate family members listed on the application to live, work and study in Australia with them. At WWICS, we have a team of expert consultants that guide you through processes like process and visa application, eligibility assessment, and ensuring that the application for visa is submitted and processed successfully within an appropriate time period for you to easily travel to Australia.</br></br>
      With a comprehensive economic policy framework, Australia offers a highly competitive market which has a sound, stable and modern infrastructure that serves as an ideal destination for investment. There are the two major reasons that make Australia a favored destination for doing business.<br>
      <span style='color:black;font-weight:bolder;'>Business and Investor Migrants</span><br><br>
      Visas fall into two main categories:<br>
      <ul style='list-style-type:circle'>
      <li>Provisional visas are pathway to permanent residency in Australia</li>
      <li>Permanent residency visas allow migrants to live and work in Australia</li>
      </ul>
      <br><br>
      There are a number of visa options for new business and investors:<br>
      <ul style='list-style-type:circle'>
      <li>Business Innovation and Investment (Provisional) (subclass 188) visa</li>
      <li>Business Talent (Permanent) (subclass 132) visa</li>
   
      </ul>
      <br><br>
      Existing business and investor visa holders may be eligible to apply for one of the following visas:<br>
      <ul style='list-style-type:circle'>
      <li>Business Innovation and Investment (Permanent) (subclass 888) visa</li>
      <li>Business Owner (Residence) (subclass 892) visa</li>
      <li>Investor (Residence) (subclass 893) visa</li>
      </ul><br><br>

      <span style='color:black;font-weight:bolder;'>PROVISIONAL VISAS
Business Innovation and Investment (Provisional) (subclass 188) visa</span><br><br>
...
You must submit an Expression of Interest (EOI) through SkillSelect and be nominated by a state or territory government or Austrade on behalf of the Australian government before being invited to apply for this visa.<br>
You must provide a full resume of your business career and responsibilities demonstrating a successful business career.

You must provide a Business Commitment (see NSW Business Commitment template) for a profitable business in NSW demonstrating sound knowledge of the Australian market, providing details of research activities that you have undertaken and an evaluation on how your proposed business or investment will perform in the NSW context. The ownership share must be at least 51% with turnover of less than A$400,000 per annum, or 30% of a business with turnover of more than A$400,000 per annum, or 10% of a publicly-listed company.<br><br>
    ...
    <div class="-my-8 divide-y-2 divide-gray-100">
      <div class="py-8 flex flex-wrap md:flex-nowrap">
        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
         <span class="font-semibold title-font text-gray-700" style='color:#D92E7C; font-weight:400;font-size:1rem'>Business Innovation Stream Visa</span>
        </div>
        <div class="md:flex-grow">
          
          <p class="leading-relaxed"  style='font-size:.8rem'>Australia encourages successful and talented business people to own or invest and benefit from opportunities in the country. The Australian Business Innovation Stream (Provisional) visa facilitates the same. This is a temporary business skills visa that supports successful business people to start a new or own existing business in Australia.</p>
      ...
      <div class="py-8 flex flex-wrap md:flex-nowrap">
        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
        <span class="font-semibold title-font text-gray-700"  style='color:#D92E7C; font-weight:400;font-size:1rem'>Business Investor Stream Visa</span>
        </div>
        <div class="md:flex-grow">
          <p class="leading-relaxed" style='font-size:.8rem'>Australia encourages successful and talented business people to own or invest and benefit from opportunities in the country. The Australian Business Investor Stream (Provisional) visa facilitates the same.</p>
...
<section class="text-gray-600 body-font overflow-hidden">
  <div class="container px-5 py-24 mx-auto">
    <div class="-my-8 divide-y-2 divide-gray-100">
      ...
      <div class="py-8 flex flex-wrap md:flex-nowrap">
        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
       <span class="font-semibold title-font text-gray-700"  style='color:#D92E7C; font-weight:400;font-size:1rem'>Business Talent Visa</span>
        </div>
        <div class="md:flex-grow">
          <p class="leading-relaxed" style='font-size:.8rem'>Australia offers opportunity for successful business people from across the world to invest in the region. The Australian Business Talent visa is an ideal option for competent business owners to explore and contribute to the success of a new or existing Australian business.</p>
