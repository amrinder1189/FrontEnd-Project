...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <h2 class="sm:text-3xl text-2xl text-gray-900 font-medium title-font mb-2 md:w-2/5" style='color:#D92E7C'>Australia Family Visa</h2>
    ...
    <!-- <h2 class="sm:text-3xl text-2xl text-gray-900 font-medium title-font mb-2 md:w-2/5" style='color:#D92E7C'>Skilled Workers Visa</h2> -->
      <p class="leading-relaxed text-base" style='color:black;opacity:1;font-weight:400;'>The Australian Family migration stream intends to reunite immediate and extended family members with their eligible Australian relatives.</br></br>
       <span style='color:black;font-weight:bolder;'> Family Spouse Visa</span><br><br>
      ...
      <span style='color:black;font-weight:bolder;'>Prospective Marriage Visa</span><br><br>
      ...
      This is a temporary visa, valid for 9 months. Visa holders should intend to marry their fiance(e) within 9 months. Post marriage, applicant can apply for an Australian Spouse visa if they wish to remain in Australia permanently with their spouse.<br><br>
      <span style='color:black;font-weight:bolder;'>Aged Parent Visa</span><br><br>
      ...
      <span style='color:black;font-weight:bolder;'>Parent Visa</span><br><br>
    ...
    <div class="-my-8 divide-y-2 divide-gray-100">
      <div class="py-8 flex flex-wrap md:flex-nowrap">
        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
         <span class="font-semibold title-font text-gray-700" style='color:#D92E7C; font-weight:400;font-size:1rem'>Spouse Visa</span>
        </div>
        <div class="md:flex-grow">
          
          <p class="leading-relaxed"  style='font-size:.8rem'>Married or genuine partners of Australian citizens or permanent residents or eligible New Zealand citizens* are eligible to apply for Australian Spouse visa. The applicants can be partners of either same opposite or same-sex.</p>
      ...
      <div class="py-8 flex flex-wrap md:flex-nowrap">
        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
        <span class="font-semibold title-font text-gray-700"  style='color:#D92E7C; font-weight:400;font-size:1rem'>Parent Visa - Working Age
</span>
        </div>
        <div class="md:flex-grow">
          <p class="leading-relaxed" style='font-size:.8rem'>The Parent visa is one of the popular migrant visas. It allows parent to join their children in Australia permanently. The child should be eligible sponsor for the parents. The Australian government restricts the number of available Parent visas each year. Consequently, if applicants meet core criteria, they can acquire position in the global queue.</p>
...
<section class="text-gray-600 body-font overflow-hidden">
  <div class="container px-5 py-24 mx-auto">
    <div class="-my-8 divide-y-2 divide-gray-100">
      ...
      <div class="py-8 flex flex-wrap md:flex-nowrap">
        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
       <span class="font-semibold title-font text-gray-700"  style='color:#D92E7C; font-weight:400;font-size:1rem'>Prospective Marriage Visa</span>
        </div>
        <div class="md:flex-grow">
          <p class="leading-relaxed" style='font-size:.8rem'>Married or genuine partners of Australian citizens or permanent residents or eligible New Zealand citizens* are eligible to apply for Australian Spouse visa. The applicants can be partners of either same opposite or same-sex. </p>
